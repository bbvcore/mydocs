---
title: ESP32 + DHT11 + MQTT
sidebar_position: 1
---

# &#128196;Código ESP32 + DHT11 + MQTT
Este código sirve para realizar mediciones de temperatura mediante el **sensor DHT11** conectado a un **ESP32** mediante conexión **WiFi** y a través del protocolo **MQTT**.

<details>
<summary>
Código fuente de un <b>ESP32</b> conectado a un <b>DHT11</b>
</summary>
